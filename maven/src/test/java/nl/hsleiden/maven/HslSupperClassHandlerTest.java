...
public class HslSupperClassHandlerTest {
    private static final String DOCUMENT = "lns:document";
    ...
    private final HslSupperClassHandler supperClassHandler = new HslSupperClassHandler(beansOnClassPath,
    ...
    public void mixinTest() {
        ...
        ContentTypeBean contentTypeBean = createContentTypeBean(supertypes, true, DOCUMENT);
    ...
    public void notParentTest() {
        ...
        List<String> supertypes = new ArrayList<String>();
        ContentTypeBean contentTypeBean = createContentTypeBean(supertypes, false, DOCUMENT);
    ...
    @Test
    public void basedocumentTest() {

        List<String> supertypes = new ArrayList<String>();
        ContentTypeBean contentTypeBean = createContentTypeBean(supertypes, false, "hsl:basedocument");
    ...
    private ContentTypeBean createContentTypeBean(List<String> supertypes, boolean isMixin, String fullyQualifiedName) {
        ...
        try {
            ...
            EasyMock.expect(contentTypeBean.getFullyQualifiedName()).andReturn(fullyQualifiedName).anyTimes();
