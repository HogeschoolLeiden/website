...
public class InterfaceHandler extends InterfacesHandler {
	private final static Logger LOG = LoggerFactory
			.getLogger(InterfaceHandler.class);

	public InterfaceHandler(Map<String, HippoBeanClass> beansOnClassPath,
	...
	@Override
	public List<ClassReference> getInterfaces(ContentTypeBean contentTypeBean,
