...
public class MenuFunctions {
	...
	public static EditableMenuItem getTopMenuItem(EditableMenu menu,
			Integer level) {
	...
	public static EditableMenuItem getMenuItem(HttpServletRequest req,
			EditableMenuItem originalMenuItem) {
		EditableMenuItem result = originalMenuItem;

		String sitemenuConfigParameter = ParametersFunctions
				.getSitemenuConfigParameter(originalMenuItem,
						"useMainMenuConfig");

		if (sitemenuConfigParameter != null
				&& "true".equalsIgnoreCase(sitemenuConfigParameter)) {
